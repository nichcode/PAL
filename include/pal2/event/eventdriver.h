 ...
 * @brief Dispatch modes for event.
 * 
 * @ingroup pal_event
 */
...
/** @brief The event will be discarded.
 * 
...
/** @brief The maximum number of dispatch modes. The literal value must
 * not be used.
 * 
 * @ingroup dispatch_modes
*/
 ...
 * @brief Dispatch mode for an event
 *
 ...
 * @brief Information about an event queue.
 * 
 ...
 * @brief Creation parameters of an event driver.
 *
 * Uninitialized fields may result in undefined behavior.
 *
 * @since Added in version 2.0
 ...
 *
 * @Thread-safety `eventDriver` parameter must be externally synchronized.
 *
 * @since Added in version 2.0
 * @ingroup pal_event
 * 
 ...
 *
 * @Thread-safety The event queue or event callback of `eventDriver`
 *                parameter must be thread safe with respect to the dispatch
 *                mode of `event` parameter. 
 *
 * @since Added in version 2.0
 * @ingroup pal_event
 * 
