...
typedef enum {
    ...
    PAL_RESULT_INVALID_GPU_ADAPTER,
    PAL_RESULT_INVALID_GPU_BACKEND,
    PAL_RESULT_GPU_COMMAND_QUEUE_NOT_SUPPORTED,
    PAL_RESULT_GPU_FEATURE_NOT_SUPPORTED,
    PAL_RESULT_INVALID_GRAPHICS_DRIVER,
    PAL_RESULT_INVALID_GPU_DEVICE,
    PAL_RESULT_INVALID_GPU_COMMAND_QUEUE,
    PAL_RESULT_OUT_OF_GPU_COMMAND_QUEUE,
    PAL_RESULT_INVALID_GPU_WINDOW,
    PAL_RESULT_INVALID_SWAPCHAIN,
    PAL_RESULT_INVALID_SWAPCHAIN_BUFFER_INDEX,
} PalResult;
