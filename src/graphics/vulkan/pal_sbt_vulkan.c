    ...
    PalShaderBindingTable** outSbt)
{
    ...
    setDebugNameVk(deviceImpl, VK_OBJECT_TYPE_BUFFER, sbt->buffer);
    setDebugNameVk(deviceImpl, VK_OBJECT_TYPE_DEVICE_MEMORY, sbt->bufferMemory);
    setDebugNameVk(deviceImpl, VK_OBJECT_TYPE_BUFFER, sbt->stagingBuffer);
    setDebugNameVk(deviceImpl, VK_OBJECT_TYPE_DEVICE_MEMORY, sbt->stagingBufferMemory);
