...
LRESULT CALLBACK videoProc(
    ...
    switch (msg) {
        ...
        case WM_SYSKEYUP: {
            ...
            extended = (lParam >> 24) & 1; // we use this for special jeys
            ...
            } else if (win32Scancode == 0x2A || win32Scancode == 0xAA) {
                return 0;
            ...
            } else if (scancode == PAL_SCANCODE_RSHIFT && win32Keycode == VK_SHIFT) {
